...
//	})
	...
	$(".reg_btn").click(function(){
		if(($("#userid").val()!="") && ($("#uidmsg").text()=="")){
			$("#uidmsg").text()="sucess";
			$("#uidmsg").hide();
		}
		else if(($("#username").val()!="") && ($("#uniname").text()=="")){
			$("#uniname").text()="sucess";
			$("#uniname").hide();
		}
		else if(($("#password").val()!="") && ($("#pword").text()=="")){
			$("#pword").text()="sucess";
			$("#pword").hide();
		}
		else if(($("#rpassword").val()!="") && ($("#rpassword").val()==$("#password").val()) && ($("#rpword").text()=="")){
			$("#rpword").text()="sucess";
			$("#rpword").hide();
		}
		else if(($("#authcode").val()!="") && ($("#imgcode").text()=="")){
			$("#imgcode").text()="sucess";
			$("#imgcode").hide();
		}
		else if(($("#uidmsg").text()=="sucess") && ($("#uniname").text()=="sucess") && ($("#pword").text()=="sucess") && ($("#rpword").text()=="sucess") && ($("#imgcode").text()=="sucess") && ($("#agreement").attr("checked")=="checked")){
			return true;
		}
		else if(($("#uidmsg").text()=="sucess") && ($("#uniname").text()=="sucess") && ($("#pword").text()=="sucess") && ($("#rpword").text()=="sucess") && ($("#imgcode").text()=="sucess")){
			alert("请选择服务条款");
			return false;
		}
		else{
	...
	$(".compl_btn").click(function(){
		...
		else if(($("#idnum").val()!="") && ($("#cardnum").text()=="")){
			$("cardnum").text()="sucess";
			$("#cardnum").hide();
		}
		else if(($("#major").val()!="") && ($("#majormsg").text()=="")){
			$("#majormsg").text()="sucess";
			$("#majormsg").hide();
		}
		else if(($("#depart").val()!="") && ($("#departmsg").text()=="")){
			$("#departmsg").text()="sucess";
			$("#departmsg").hide();
		}
		else if(($("#title").val()!="") && ($("#titlemsg").text()=="")){
			$("#titlemsg").text()="sucess";
			$("#titlemsg").hide();
		}
		else if(($("#address").val()!="") && ($("#addressmsg").text()=="")){
			$("#addressmsg").text()="sucess";
			$("#addressmsg").hide();
		}
		else if(($("#zipcode").val()!="") && ($("#zipcodemsg").text()=="")){
			$("#zipcodemsg").text()="sucess";
			$("#zipcodemsg").hide();
		}
		else if(($("#phone").val()!="") && ($("#phonemsg").text()=="")){
			$("#phonemsg").text()="sucess";
			$("#phonemsg").hide();
		}
		else if(($("#email").val()!="") && ($("#emailmsg").text()=="")){
			$("#emailmsg").text()="sucess";
			$("#emailmsg").hide();
		}
	...
	$(".wyx input[type='checkbox']").click(function(){
		if($(this).attr("checked") == "checked" &&( $(this).val() == "CDYXWYX"||$(this).val() == "DJZKWYX")){
