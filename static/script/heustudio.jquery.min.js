...
$(document).ready(function(){
	...
	$(".addline").click(function(){ 
		...
		$("#"+biaoshi).append($("#ss .item").clone(true));//克隆
		//radiobutton
		$("#"+biaoshi+" .item #count .cinfoi").attr("name","m"+data+"nn"+count);
	...
	$(".uinfo .inptxt").blur(function(){
		...
		switch(in_array(t,arr)){
			...
			case "6":
			    var reg=/^[0-9]$/;
			    if(!reg.test(v)){
			    	tipinfo="身份证号都是数字，请填写正确的身份证号！";
			    }
			    else if(v.length!=18){
			    	tipinfo="身份证号长度是13，请填写正确的身份证号！";
			    }
			    break;
			case "7":
			    if(v==""){
