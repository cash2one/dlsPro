...
$(document).ready(function(){
	...
	$(".addline").click(function(){ 
		...
		var htmlt = "<div class=\"item linehtml\" id=\""+idname+"\"  style=\"margin-top:10px;\" data="+data+"><fieldset class=\"fieldsetborder\"><legend>数量</legend><input type=\"radio\" name=\""+idname+"nn\" class=\"cinfoi\"  value=\"个别\" />个别<input type=\"radio\" name=\""+idname+"nn\" class=\"cinfoi\"  value=\"少数\"  />少数<input type=\"radio\" name=\""+idname+"nn\" class=\"cinfoi\"   value=\"多数\" />多数</fieldset><fieldset style=\"margin-left:18px;\" class=\"fieldsetborder\"><legend>程度</legend><input type=\"radio\" name=\""+idname+"nl\" class=\"cinfoi\"  value=\"轻微\"  />轻微<input type=\"radio\" name=\""+idname+"nl\" class=\"cinfoi\"  value=\"中等\"  />中等<input type=\"radio\" name=\""+idname+"nl\" class=\"cinfoi\"   value=\"严重\" />严重</fieldset><img src=\"/static/img/minus.png\" class=\"minline\" /><div class=\"tipinfo linetip\" style=\"display: none;\"><div class=\"arrow_top\"><img src=\"/static/img/arrow_top.png\"></div><div class=\"htip\"><p>删除该条数量程度描述</p></div></div><div><label>描述</label><input type=\"text\" class=\"tb\" placeholder=\"[备注]\" /><div class=\"ccvs\"><input type=\"text\" class=\"ts n\" id=\"ts"+idname+"\" disabled=\"disabled\" value=\"0\" /><div class=\"pl5min\" disabled=\"disabled\"><img src=\"/static/img/select_bup.png\" class=\"plus\" data=\""+idname+"\" /><img src=\"/static/img/select_bdown.png\" class=\"minus\" data=\""+idname+"\" /></div></div></div></div>";
		$(this).parents(".dlisf").append(htmlt);
		$("#iii #"+data+"i").append("<p class=\"i "+idname+"i addedi\">『<span class=\"nl\"></span>』 - 『备注：<span class=\"bz\"></span>』 - 『<span class=\"ns\">0</span>』</p>");
	});
	
	$(".minline").on("mouseover",function(){ 
		$(this).next(".linetip").show();
	});
	$(".minline").on("mouseout",function(){ 
		$(this).next(".linetip").hide();
	});
	...
	$(".uinfo .inptxt").blur(function(){
		...
		var arr = [ "username", "pass", "rpass", "code" ];
		var t = o.attr("data");
		var v = o.val();
	...
	$(".reg_btn").click(function(){
		var reg =  /^[a-zA-Z_]{1}[0-9a-zA-Z_]{1,}$/;
		if((reg.test($("#username").val())) && ($("#username").val().length > 6) && ($("#username").val().length < 30) && ($("#password").val().length > 6) && ($("#rpassword").val().length > 6) && ($("#password").val() == $("#rpassword").val()) && ($("#agreement").attr("checked") == "checked")) {
