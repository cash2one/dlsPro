...
$(document).ready(function(){
  ...
  //   	$("#suc").fadeOut();
	...
	if($(".result .retd").html() == "可用"){
 		$(".report #doc").css("background","green");
 	}
 	else{
 		$(".report #doc").css("background","#EE30A7");
 	}
...
this.imagePreview = function(){	
	...
	$(".preview").hover(function(e){
		...
		$(this).parent(".yshow").append("<div id='preview'><img src='"+ this.name +"' alt='Image preview' class='iini'/>"+ c +"</div>");
