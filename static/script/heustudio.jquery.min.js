  ...
  //   	$("#suc").fadeOut();
	...
	$(".cinfoi").on("change",function() {
		...
		if(ids != null){
			...
			var lastid = ids.substr(ids.length-1,1);
			var sid = ids.substr(0,3);
			var lastcdo = $("#"+ids).children("fieldset").children("input[name='m"+sid+"nl"+lastid+"']:checked");
			if((cdo.size() == 0)){	
	...
	$(".wzs").click(function(){
		...
		$("#dinfotip #p"+$(this).parents(".oitem").children(".item").attr("id")).prev("h3").css("display","none");
