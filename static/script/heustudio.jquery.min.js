...
//	})
	...
	$(".cinfoi").on("change",function() {
		...
		if(addspan.children().children().length==0)
		{
			...
			addspan.prev().removeClass("hover");
		}
		...
		alert($("#dinfotip #"+pids+" #p"+ids).html());
		$("#dinfotip #"+pids+" #p"+ids).show();
		$("#dinfotip #"+pids+" #"+ids+" .nl").html(hsl+hcd);
		$("#dinfotip #"+pids+" #"+ids).show();
	...
	$(".dlisf div .tb").on("blur",function(){
		...
		alert(ids);
		alert(pids);
		$("#dinfotip #"+pids+" #"+ids+" .bz").html(v);
		alert($("#dinfotip #"+pids+" #"+ids+" .bz").html());
		$("#dinfotip #"+pids+" #"+ids).attr("display","block");
		// $("#iii ."+ids+"i .bz").html(v);
	...
	$(".dlisf div .ts").on("blur",function(){
		...
		alert(ids);
		alert(pids);
		$("#dinfotip #"+pids+" #"+ids+" .ns").html(v);
		alert($("#dinfotip #"+pids+" #"+ids+" .ns").html());
		$("#dinfotip #"+pids+" #"+ids).attr("display","block");
	});
...
$(".addsearchMap").click(function(){
	...
	$(".reg_btn").click(function(){
		...
		// 	return false; 
		// }
		else if($("#uniname").text() !="sucess")
		{
			alert("用户名未按规则填写");
			return false;
		}
		else if($("#pword").text() !="sucess")
		{
			alert("密码未按规则填写");
			return false;
		}
		else if($("#rpword").text()!="sucess")
		{
			alert("确认密码未按规则填写");
			return false;
		}
		else if($("#imgcode").text()!="")
		{
			alert("验证码未按规则填写");
			return false;
		}
	...
	$(".compl_btn").click(function(){
		...
		else if($("#majormsg").text()!=""){
			alert("专业未按规则填写");
			return false;
		}
		else if($("#departmsg").text()!=""){
			alert("单位未按规则填写");
			return false;
		}
		if($("#titlemsg").text()!=""){
