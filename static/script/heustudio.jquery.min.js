...
$(document).ready(function(){
	if(($("#suc").text()=="修改成功！") || ($("#suc").text()=="两次密码输入不一致！") || ($("#suc").text()=="请输入密码！") || ($("#suc").text()=="密码错误！")){
    	$("#suc").fadeOut(2000);
		$("#suc").fadeOut("slow");
  //   	$("#suc").fadeOut();
	}
...
$(".addsearchMap").click(function(){
	...
	$(".reg_btn").click(function(){
		//判断用户名
		//if(($("#username").val()!="") && ($("#uniname").text()=="")){
		//	$("#uniname").text()="sucess";
		//	$("#uniname").hide();
		//}
		//判断密码
		//if(($("#password").val()!="") && ($("#pword").text()=="")){
		//	$("pword").text()="sucess";
		//	$("#pword").hide();
		//}
		//判断确认密码'''
		//if(($("#rpassword").val()!="") && ($("#rpassword").val()==$("#password").val()) && ($("#rpword").text()=="")){
		//	$("#rpword").text()="sucess";
		//	$("#rpword").hide();
		//}
		//判断验证码'''
		//if(($("#authcode").val()!="") && ($("#imgcode").text()=="")){
		//	$("#imgcode").text()="sucess";
		//	$("#imgcode").hide();
		//}
		if(($("#uniname").text()=="sucess") && ($("#pword").text()=="sucess") && ($("#rpword").text()=="sucess") && ($("#imgcode").text()=="sucess") && ($("#agreement").attr("checked")=="checked")){
			return true;
		}
		else if(($("#uniname").text()=="sucess") && ($("#pword").text()=="sucess") && ($("#rpword").text()=="sucess") && ($("#imgcode").text()=="sucess")){
			alert("请选择服务条款");
			return false;
		}
		else{
	...
	$(".compl_btn").click(function(){
		if(($("#realname").val()!="") && ($("#rname").text()=="")){
			$("#rname").text()="sucess";
			$("#rname").hide();
		}
		if(($("#idnum").val()!="") && ($("#cardnum").text()=="")){
			$("cardnum").text()="sucess";
			$("#cardnum").hide();
		}
		if(($("#major").val()!="") && ($("#majormsg").text()=="")){
			$("#majormsg").text()="sucess";
			$("#majormsg").hide();
		}
		if(($("#depart").val()!="") && ($("#departmsg").text()=="")){
			$("#departmsg").text()="sucess";
			$("#departmsg").hide();
		}
		if(($("#title").val()!="") && ($("#titlemsg").text()=="")){
			$("#titlemsg").text()="sucess";
			$("#titlemsg").hide();
		}
		if(($("#address").val()!="") && ($("#addressmsg").text()=="")){
			$("#addressmsg").text()="sucess";
			$("#addressmsg").hide();
		}
	    if(($("#zipcode").val()!="") && ($("#zipcodemsg").text()=="")){
			$("#zipcodemsg").text()="sucess";
			$("#zipcodemsg").hide();
		}
		if(($("#phone").val()!="") && ($("#phonemsg").text()=="")){
			$("#phonemsg").text()="sucess";
			$("#phonemsg").hide();
		}
		if(($("#email").val()!="") && ($("#emailmsg").text()=="")){
			$("#emailmsg").text()="sucess";
			$("#emailmsg").hide();
		}
		if(($("#rname").text()=="sucess") && ($("#cardnum").text()=="sucess") && ($("#majormsg").text()=="sucess") && ($("#addressmsg").text()=="sucess") && ($("#zipcodemsg").text()=="sucess") && ($("#departmsg").text()=="sucess") && ($("#titlemsg").text()=="sucess")&& ($("#phonemsg").text()=="sucess") && ($("#emailmsg").text()=="sucess")){
	 ...
	 $.post("/t/countAjax",
        ...
        if(data.length>0)
        {
        	...
        	if(pageleng>1&&pagenow>1){
        		$("#pagestyle").append("<li> <a  title='上一页' href='?page="+pagenow-1+"'><span>&lt;&lt;</span></a></li>");
			}
			for(var q = 1;q<=pageleng;q++)
			{
				if(q==pagenow)
				{
					...
					$("#pagestyle").append("<li>  <a  href='?page="+q+"' title='q'><span>"+q+"</span></a></li>");
			} 
			if(pagenow<pageleng)
			{
				$("#pagestyle").append("<li> <a  title='下一页' href='?page="+(pagenow+1)+"'><span>&gt;&gt;</span></a></li>");
			}
