...
$(document).ready(function(){
	...
	$("#userid").blur(function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				//n=$("#userid")
				//if(!data){
				//	n.css("border-color","#f00");
				//	n.parent("p").next(".wrongtip").html(data.msg).show();
				//}
				//else{
				//	n.css("border-color","#cfcdc7");
				//	n.parent("p").next(".wrongtip").hide();
				//}'''
				//alert(data.msg);
	...
	$(".uinfo .inptxt").blur(function(){
		...
		var arr = ["username", "pass", "rpass", "code", "realname", "idnum", "major", "depart","title", "address","zipcode", "phone", "email"];
		var t = o.attr("data");
		var v = o.val();
