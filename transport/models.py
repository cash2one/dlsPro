...
class sys_user(models.Model):
	...
	user_email = models.CharField(max_length=30,verbose_name='邮件地址',blank=True,null=True)
...
class EQInfo(models.Model):
	...
	eq_epicentralintensity = models.CharField(max_length=10,verbose_name='中心烈度',blank=True,null=True)
...
class building_structure(models.Model):
	...
	construct_remark = models.CharField(max_length=50,verbose_name='备注',blank=True,null=True)
...
class region(models.Model):
	...
	region_areadesc = models.CharField(max_length=50,verbose_name='区域描述',blank=True,null=True)
...
class building_information(models.Model):
	...
	building_buildusage = models.CharField(max_length=20,verbose_name='建筑物用途',blank=True,null=True)
...
class damage(models.Model):
	...
	damage_sublocationfactor = models.FloatField(verbose_name='部位因子',blank=True,null=True)
...
class identify_result(models.Model):
	...
	result_result = models.CharField(max_length=20,verbose_name='鉴定结果',blank=True,null=True)
...
class t_admin(models.Model):
	...
	admin_adminname = models.CharField(max_length=10,verbose_name='用户姓名',blank=True,null=True)
